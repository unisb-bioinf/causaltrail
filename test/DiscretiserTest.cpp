...
TEST_F(DiscretiserTest,FloorIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
	ASSERT_EQ(0,dObs(0,0));
...
TEST_F(DiscretiserTest,CeilIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
...
TEST_F(DiscretiserTest,RoundIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
	ASSERT_EQ(-1,dObs(0,2));
	ASSERT_EQ(0,dObs(1,2));
	ASSERT_EQ(0,dObs(2,2));
	ASSERT_EQ(1,dObs(3,2));
	ASSERT_EQ(2,dObs(4,2));
...
TEST_F(DiscretiserTest,AMeanIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
...
TEST_F(DiscretiserTest,HMeanIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
	ASSERT_EQ(-1,dObs(0,4));
	ASSERT_EQ(0,dObs(1,4));
	ASSERT_EQ(0,dObs(2,4));
	ASSERT_EQ(1,dObs(3,4));
	ASSERT_EQ(1,dObs(4,4));
...
TEST_F(DiscretiserTest,MedianIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
...
TEST_F(DiscretiserTest,ManuallyIncludingNA){
		Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
...
TEST_F(DiscretiserTest,BracketMediansIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
	ASSERT_EQ(0,dObs(0,7));
	ASSERT_EQ(1,dObs(1,7));
	ASSERT_EQ(0,dObs(2,7));
	ASSERT_EQ(-1,dObs(3,7));
	ASSERT_EQ(1,dObs(4,7));
	ASSERT_EQ(1,dObs(5,7));
...
TEST_F(DiscretiserTest,PerasonTukey){
	...
	ASSERT_EQ(1,dObs(2,8));
	ASSERT_EQ(1,dObs(3,8));
	ASSERT_EQ(2,dObs(4,8));
	ASSERT_EQ(2,dObs(5,8));
}

TEST_F(DiscretiserTest,PerasonTukeyIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
	ASSERT_EQ(-1,dObs(0,8));
	ASSERT_EQ(1,dObs(1,8));
	ASSERT_EQ(1,dObs(2,8));
	ASSERT_EQ(1,dObs(3,8));
...
TEST_F(DiscretiserTest,MapNamesToIntNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);
	ASSERT_EQ(1,dObs(0,9));
	ASSERT_EQ(-1,dObs(1,9));
	ASSERT_EQ(1,dObs(2,9));
	ASSERT_EQ(1,dObs(3,9));
	ASSERT_EQ(0,dObs(4,9));
	ASSERT_EQ(0,dObs(5,9));
...
TEST_F(DiscretiserTest, ZIncludingNA){
	Matrix<std::string> oriObs (TEST_DATA_PATH("testObservationsIncludingNA.txt"),false,true);
	Matrix<int> dObs (oriObs.getColCount(), oriObs.getRowCount(),0);
	Network n;
	Discretiser d (oriObs,TEST_DATA_PATH("jsonDiscretiserTest.json"),dObs,n);	
	ASSERT_EQ(0,dObs(0,10));
	ASSERT_EQ(0,dObs(1,10));
	ASSERT_EQ(0,dObs(2,10));
	ASSERT_EQ(0,dObs(3,10));
	ASSERT_EQ(0,dObs(4,10));
	ASSERT_EQ(-1,dObs(5,10));
}
