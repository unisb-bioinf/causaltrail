...
int Controller::computeParentCombinations(std::vector<unsigned int> parents){
...
void Controller::assignObservationsToNodes(){
...
void Controller::assignValueNames(Node& n){
...
void Controller::assignParentNames(Node& n){
...
void Controller::countObservations(Matrix<int>& obsMatrix, Node& n){
